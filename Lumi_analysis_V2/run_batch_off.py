...
output_path = "/home/phbelang/abp/WireDAQ/Results_Lumi_V2/wires_off/"
...
#wiresON  = False
#SAVING   = False
#SAVEPATH = '../Results_Lumi_V2/wires_off/'
########################################


for fill in fills_to_analyze:
    params = {"FILL": fill,'wiresON':False,'SAVING':True,'SAVEPATH' : '../Results_Lumi_V2/wires_off/'}
    pm.execute_notebook(
